...
---
 ...
 1. Using Python :    
       ...
       A)  Install [Anaconda Installer](https://docs.anaconda.com/anaconda/install/windows/)
       
       B)  Create a Virtual Environment : [Tutorial](https://docs.python.org/3/library/venv.html)
  ...
  2. Will update the desktop application (.exe) soon. The desktop app can be used without any dependencies.
...
## And last but not the least follow me on [github](https://github.com/sagnik1511) and in [kaggle](https://kaggle.com/sagnik1511)
